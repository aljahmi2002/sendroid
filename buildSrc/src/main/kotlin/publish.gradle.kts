    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/aljahmi2002/sendroid/")
                ...
                developers {
                    developer {
                        id.set("aljahmi2002")
                        name.set("aljahmi2002")
                    }
                }
                scm {
                    connection.set("scm:git:git://github.com/aljahmi2002/sendroid.git")
                    developerConnection.set("scm:git:ssh://github.com/aljahmi2002/sendroid.git")
                    url.set("https://github.com/aljahmi2002/sendroid/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/aljahmi2002/sendroid/issues")
                }
            }
        }
    }
